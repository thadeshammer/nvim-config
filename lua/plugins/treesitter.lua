return {
    ...
    opts = {
      ...
      highlight = {
        ...
        disable = function(lang, buf)
          -- This does not fix the issue where XML bombs Neovim.
          if lang == "xml" then
            -- disable for all xml
            return true
          end
  ...
  -- Opening an XML file when this is loaded crashes Neovim
  -- So far, trying to add exclude clauses to this for xml have not fixed this
  -- {
  ...
  --       enable = true,
  --       -- xml files crash Neovim when seen by this plugin
  --       filetype_exclude = { "xml" },
  --     })
  --   end,
  -- },
